...
#usage: dynListNodes.ps1 <nodename>                                                 #
#####################################################################################
...
#Get Existing Node Records for the Zone
     Invoke-RestMethod -Uri "https://api2.dynect.net/REST/AllRecord/$zone/" -Method GET -ContentType "application/json" -Headers $headers
